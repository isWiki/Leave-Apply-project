...
export function renderForm(root, onChangePage, prefill) {
    if (prefill)
        cacheForm = { ...prefill };
    ...
    btnPreview.onclick = () => {
        const val = {
            applicantId: document.getElementById('selUser').value,
